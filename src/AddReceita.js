...
export default class AddReceita extends Component
{
    ...
    add() {
    if(this.state.valor != '' && this.state.name != '' && this.state.produto != '') {
...
render()
{
    return (
        <View style={styles.container}>
                ...
                <Text style={styles.saldo}>Adicione suas receitas</Text>
                <TextInput
                   style={styles.input}
                ...
                <TextInput
                style={styles.input}
                placeholder='Forma de Pagamento - dinheiro | cartao'
                onChangeText={(pagamento)=>this.setState({pagamento})}
